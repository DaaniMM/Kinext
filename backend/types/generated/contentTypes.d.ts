...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoria: Schema.Attribute.JSON &
      Schema.Attribute.Required &
...
export interface ApiEjercicioEjercicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    analises: Schema.Attribute.Relation<'oneToMany', 'api::analisis.analisis'>;
    categoria: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deficultad: Schema.Attribute.Enumeration<
    ...
    > &
      Schema.Attribute.Private;
    musculo_trabajado: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        [
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_demo: Schema.Attribute.Media<'files' | 'videos'> &
      Schema.Attribute.Required;
  };
}

export interface ApiEntrenadorEntrenador extends Struct.CollectionTypeSchema {
  collectionName: 'entrenadores';
  info: {
    displayName: 'Entrenadores';
    pluralName: 'entrenadores';
    singularName: 'entrenador';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    certificaciones: Schema.Attribute.RichText;
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    especialidad: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        [
      ...
      > &
      Schema.Attribute.DefaultTo<'[]'>;
    experiencia_anos: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 50;
        ...
        number
      >;
    foto_perfil: Schema.Attribute.Media<'files' | 'images'> &
      Schema.Attribute.Required;
    idiomas: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        [
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::entrenador.entrenador'
    > &
      Schema.Attribute.Private;
    modalidad: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        ['presencial', 'online']
    ...
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    num_resenas: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    precio_sesion: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valoracion: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 0;
...
export interface ApiResenaResena extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entrenador: Schema.Attribute.Relation<
      'manyToOne',
      'api::entrenador.entrenador'
    >;
    fecha: Schema.Attribute.Date & Schema.Attribute.Required;
